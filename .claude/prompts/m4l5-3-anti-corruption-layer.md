...
description: Plan refaktoryzacji warstwy antykorupcyjnej w celu rozwiązania problemu przeciekających zależności.
license: CC-BY-4.0
metadata:
  tags: refactor, DDD, anti-corruption layer, dependency, domain
---
